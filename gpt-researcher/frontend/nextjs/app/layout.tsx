...
let title = "Intelli-Credit";
let description =
  "Borrower intake, diligence, scoring, and appraisal memo generation built on GPT Researcher with local docling and surya adapters.";
let url = "https://github.com/assafelovic/gpt-researcher";
let ogimage = "/favicon.ico";
let sitename = "Intelli-Credit";
